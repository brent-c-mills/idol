...
##--DECLARING DIRECTORY STRUCTURE
	...
	BASE_DIR="`pwd`"
#NOTE:  This file will eventually move to the bin directory.  The future installation script will set the true BASE_DIR and will adjust the tree based around it.
