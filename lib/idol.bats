@test "IDOL DIRECTORY STRUCTURE CHECK - .git/COMMIT_EDITMSG" {
[[ -e .git/COMMIT_EDITMSG ]]
}
 
@test "IDOL DIRECTORY STRUCTURE CHECK - .git/config" {
[[ -e .git/config ]]
}
 
@test "IDOL DIRECTORY STRUCTURE CHECK - .git/FETCH_HEAD" {
[[ -e .git/FETCH_HEAD ]]
}
 
@test "IDOL DIRECTORY STRUCTURE CHECK - .git/HEAD" {
[[ -e .git/HEAD ]]
}
 
@test "IDOL DIRECTORY STRUCTURE CHECK - .git/index" {
[[ -e .git/index ]]
}
 
@test "IDOL DIRECTORY STRUCTURE CHECK - .git/logs/HEAD" {
[[ -e .git/logs/HEAD ]]
}
 
@test "IDOL DIRECTORY STRUCTURE CHECK - .git/ORIG_HEAD" {
[[ -e .git/ORIG_HEAD ]]
}
 
@test "IDOL DIRECTORY STRUCTURE CHECK - .git/packed-refs" {
[[ -e .git/packed-refs ]]
}
